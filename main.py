...
def get_model_info():
    ...
    try:
        ...
        classes = []
        error = f"Error: {e}"
        return render_template("index.html", models=models, classes=classes, error=error)
...
def show_model(model_id):
    ...
    try:
        ...
        curr_car = []
        error = f"Error: {e}"
        return render_template("index.html", models=models, classes=classes, curr_car=curr_car, error=error)
